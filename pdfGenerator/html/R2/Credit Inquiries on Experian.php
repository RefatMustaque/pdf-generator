...
<div class="container .fontDescription">
        ...
        <div class="proof">
           ...
           <span style="padding-bottom:40px;font-weight: bold;line-height:3em; text-align:center; border-bottom:2px solid black">SECOND DEMAND REQUEST OF PROOF OF WRITTEN REQUEST</span></p>
            ...
            <p>Pursuant to these 3 sections you are required under the FCRA to provide me with Valid Proof of my Written Request, the Proper Identification and the Certification required for the inquiries on my credit profile.</p>
